globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import fs, { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, callNodeListener, createError, getQuery } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/h3/dist/index.mjs';
import multer from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/multer/index.js';
import { getAudioDurationInSeconds } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/get-audio-duration/dist/commonjs/index.js';
import { createRenderer } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/scule/dist/index.mjs';
import { hash } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/ufo/dist/index.mjs';
import { createStorage } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/john/Code/vue/AudioVisualiser/frontend/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/john/Code/vue/AudioVisualiser/frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/john/Code/vue/AudioVisualiser/frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/john/Code/vue/AudioVisualiser/frontend/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/john/Code/vue/AudioVisualiser/frontend/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/john/Code/vue/AudioVisualiser/frontend/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_Cn9Oqf = () => Promise.resolve().then(function () { return tracks_post$1; });
const _lazy_mHYg5F = () => Promise.resolve().then(function () { return tracks_get$1; });
const _lazy_c8iDXZ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/tracks', handler: _lazy_Cn9Oqf, lazy: true, middleware: false, method: "post" },
  { route: '/api/tracks', handler: _lazy_mHYg5F, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_c8iDXZ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_c8iDXZ, lazy: true, middleware: false, method: undefined }
];
...
const tracks_post = defineEventHandler(async (event) => {
  console.log(event);
  try {
...
const tracks_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: tracks_post
});

const tracks_get = defineEventHandler(async (event) => {
  const directoryPath = `${process.cwd()}/server/api/uploads`;
  const generateFiles = async () => await fs.promises.readdir(directoryPath, (error, files2) => files2).catch((error) => console.log(error));
  const files = await generateFiles();
  const generateTracks = async () => {
    const promises = files.map(
      (file) => getAudioDurationInSeconds(`${directoryPath}/${file}`).then((duration) => {
...
const tracks_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: tracks_get
});
...
const getClientManifest = () => import('/home/john/Code/vue/AudioVisualiser/frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/john/Code/vue/AudioVisualiser/frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
